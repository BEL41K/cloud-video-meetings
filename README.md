...
CloudMeet Lite — это демонстрационное веб-приложение, реализующее упрощенную платформу для видеоконференций с акцентом на микросервисную архитектуру, контейнеризацию и CI/CD.
